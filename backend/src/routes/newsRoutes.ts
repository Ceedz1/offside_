...
router.get("/", async (req, res) => {
    try {
        ...
        const url = `https://newsapi.org/v2/everything?q=("Premier League" OR "La Liga" OR "Bundesliga" OR "Serie A" OR "Ligue 1" OR "Champions League" OR "Europa League" OR "World Cup" OR "transfer" OR "Haaland" OR "Mbappe" OR "Messi" OR "Cristiano Ronaldo" OR "Bellingham" OR "Inter Miami" OR "Real Madrid" OR "Manchester City" OR "Liverpool" OR "Bayern Munich" OR "PSG") NOT (cricket OR IPL OR NBA OR basketball OR NFL OR rugby OR tennis OR golf OR F1 OR boxing OR cycling OR baseball OR hockey)&domains=bbc.co.uk,onefootball.com,theguardian.com,skysports.com,espn.com,reuters.com,apnews.com&language=en&sortBy=publishedAt&pageSize=40&apiKey=${apiKey}`;
